...
| `top-links`         | [`Link[]`](./src/types/LinkType.ts) |   `false`   |        `undefined`         | Liens de la partie supérieur                      |
| `bottom-links`      | [`Link[]`](./src/types/LinkType.ts) |   `false`   |        `undefined`         | Liens de la partie inférieure                     |
