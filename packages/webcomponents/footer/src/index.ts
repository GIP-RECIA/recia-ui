  ...
  render(): TemplateResult {
    return html`
      <div class="footer">
        <div class="top">
          <div class="container">
            <img src="./svg/netocentre.svg" class="footer-logo" alt="">
        ...
        <div class="bottom">
          <div class="container">
            ...
            <span class="footer-made-by">${getIcon(faHeart)} ${msg(str`Fait avec amour par le ${'GIP RECIA'}`)}</span>
          </div>
        </div>
      </div>
    `
