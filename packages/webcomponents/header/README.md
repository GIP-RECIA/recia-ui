...
| `groups-api-url`                          |                   `string`                   |   `false`   |        `undefined`         | URL/path de l'API groups du portail                                                                       |
...
| `user-org-id-attribute-name`              |                   `string`                   |   `false`   |        `undefined`         | Attribut de l'API informations utilisateur donnant l'organisation courante de l'utilisateur               |
| `user-all-orgs-id-attribute-name`         |                   `string`                   |   `false`   |        `undefined`         | Attribut de l'API informations utilisateur donnant la liste des organisations de l'utilisateur            |
...
| `notification-refresh-delay`              |                   `number`                   |   `false`   |          `60000`           | Délais de rafraichissement des notifications                                                              |
...
| `mediacentre-portal-favorite-api-url-put` |                   `string`                   |   `false`   |        `undefined`         | URL/path de l'API put des préférences portail pour le Médiacentre                                         |
| `mediacentre-redirect-url-pattern`        |                   `string`                   |   `false`   |        `undefined`         | Pattern de redirection pour les ressourecs du Médiacentre                                                 |
...
| `drawer-items`                            | [`DrawerItem[]`](./src/types/drawerTypes.ts) |   `false`   |        `undefined`         | Ressources supplémentaires du tiroir de navigation                                                        |
